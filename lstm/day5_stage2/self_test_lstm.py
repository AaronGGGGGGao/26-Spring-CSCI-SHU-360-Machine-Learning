"""
Self-test for the stage1-oriented 3-day LSTM sequence model.
"""
...
def main() -> None:
    ...
    val_seq = build_sequence_dataset(train_val_df, lookback=LOOKBACK, target_dates=val_dates, require_target=True)
    test_seq = build_sequence_dataset(train_val_test_df, lookback=LOOKBACK, target_dates=test_dates, require_target=True)
