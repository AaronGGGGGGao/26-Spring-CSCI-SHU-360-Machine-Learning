"""
Feature engineering for the 3-day XGBoost baseline.

This keeps the provided baseline feature set unchanged and only aligns the
forward target horizon to 3 trading days for stage1-style evaluation.
"""
...
def build_features(prices: pd.DataFrame) -> pd.DataFrame:
    ...
    return _cross_sectional_ranks(panel)
