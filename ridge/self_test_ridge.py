"""
Self-test for the Ridge model using a train/validation/test time split.
"""
...
from ridge.ridge_model import DEFAULT_TOP_K, evaluate_model, parse_alphas, select_alpha  # noqa: E402
