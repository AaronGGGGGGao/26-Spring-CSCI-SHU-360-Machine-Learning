"""
Self-test for the 3-day basic Ridge model.
"""
...
from ridge.day3_basic.features import FORWARD_HORIZON, build_features, training_frame  # noqa: E402
from ridge.day3_basic.ridge_model import DEFAULT_TOP_K, evaluate_model, parse_alphas, select_alpha  # noqa: E402
