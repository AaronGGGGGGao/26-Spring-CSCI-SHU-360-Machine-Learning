"""
Feature engineering for the 3-day basic Ridge model.

This keeps the original baseline feature set and only changes the target
horizon from 5 trading days to 3 trading days.
"""
