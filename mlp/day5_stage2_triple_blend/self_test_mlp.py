"""
Canonical self-test for the Stage 2 5-day triple score blend.
"""
...
def main() -> None:
    ...
    print(">> Stage 2 5-day triple-blend self-test split")
    ...
    print(">> Training recent-window, style-dynamic, and 5d-feature branches")
    ...
    scored_val = _score_frame(recent_model, style_model, feature5d_model, frames["recent_val"], frames["style_val"], frames["feature5d_val"])
    best_weights, best_top_k, best_method, val_metrics, leaderboard = select_blend(
        scored_val, index_df, blend_weights, top_ks, methods
    )

    scored_test = _score_frame(recent_model, style_model, feature5d_model, frames["recent_test"], frames["style_test"], frames["feature5d_test"])
    ...
    print(f"   feature5d branch: {branch['feature5d'][1]} / {branch['feature5d'][5]} / {branch['feature5d'][6]} / {branch['feature5d'][7]}")
    ...
    if args.json_out:
        out = {
            ...
            "branch_feature5d": {
                ...
                "selected_train_rows": branch["feature5d"][3],
                "selected_train_dates": branch["feature5d"][4],
