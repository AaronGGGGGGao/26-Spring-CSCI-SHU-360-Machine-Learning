"""
Walk-forward robustness evaluation for the Stage 2 5-day recent/style score blend.
"""
...
def main() -> None:
    ...
    print(">> Stage 2 5-day blend walk-forward windows")
    for spec in windows:
        print(
    ...
    for spec in windows:
        ...
        print(f">> Training blend window {spec['window_id']}")
    ...
    print(">> Aggregate Stage 2 5-day blend walk-forward result")
    ...
    if args.json_out:
        out = {
            "dataset": "data",
            "model_family": "mlp_day5_stage2_style_recent_blend",
            "methodology": {
                "type": "walk_forward",
                "windows": args.windows,
                "val_days": args.val_days,
