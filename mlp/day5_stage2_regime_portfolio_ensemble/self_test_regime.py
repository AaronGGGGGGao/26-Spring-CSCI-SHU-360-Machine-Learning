"""Canonical self-test for the Stage 2 regime-aware portfolio ensemble."""
...
def main() -> None:
    ...
    print(">> Stage 2 5-day regime-ensemble self-test split")
    ...
    test_series, test_metrics = evaluate_regime_bundle(
        bundle,
        frames["recent_test"],
        frames["style_test"],
    ...
    print(f"   defensive: top {bundle['selected_defensive_top_k']} / {bundle['selected_defensive_weight_method']}")
    print(
