"""
Robust self-test for the regime-aware tuned stage1 3-day MLP model.

Compared with the canonical self-test, this version uses:

- a longer validation block
- a longer test block
- the same embargo logic
- the same regime-aware model and portfolio search
"""
...
from mlp.day3_stage1_regime_aware.mlp_model import (  # noqa: E402
    MLP_CONFIGS,
    RECENCY_HALF_LIVES,
    REGIME_STRENGTHS,
    evaluate_model,
...
def main() -> None:
    ...
    print(">> Training regime-aware tuned MLP (robust split)")
