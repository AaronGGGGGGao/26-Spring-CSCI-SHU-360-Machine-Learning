"""Walk-forward evaluation for the Stage 2 static meta portfolio ensemble."""
...
def build_walk_forward_windows(pool, *, windows, val_days, test_days, embargo_days, min_train_days) -> list[dict]:
...
def _pool(recent_panel, as_of: str | None):
...
def main() -> None:
    ...
    print(">> Stage 2 5-day static-meta walk-forward windows")
    for spec in windows:
        print(
    ...
    for spec in windows:
        ...
        print(f">> Training static meta window {spec['window_id']}")
        ...
        _, test_metrics = evaluate_static_meta(
            bundle,
            frames["recent_test"],
            frames["style_test"],
    ...
    print(">> Aggregate Stage 2 5-day static-meta walk-forward result")
    print(
    ...
    if args.json_out:
        out = {
            "dataset": "data",
            "model_family": "mlp_day5_stage2_static_meta_portfolio_ensemble",
            "methodology": {
                "type": "walk_forward",
                "windows": args.windows,
                "val_days": args.val_days,
