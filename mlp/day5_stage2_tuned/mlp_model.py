"""
Tuned stage1-oriented 3-day MLP model.

This version keeps the same target and feature panel as the current leader,
but narrows the search around the winner:
  - finer softmax temperature search
  - light volatility-aware weighting
  - small neighborhood around the winning MLP architecture
"""
...
def main() -> None:
    ...
    p.add_argument("--weight-methods", default="softmax_1.0,softmax_1.2,softmax_1.5,softmax_1.8,softmax_2.0,softmax_risk_1.2_0.25,softmax_risk_1.5_0.25,softmax_risk_1.5_0.50")
