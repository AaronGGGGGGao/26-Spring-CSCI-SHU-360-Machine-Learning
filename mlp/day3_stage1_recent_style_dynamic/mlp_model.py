"""
Recent-window search on top of the style-dynamic 3-day tuned MLP.

This branch combines the two strongest remaining ideas:
  - recent-window training to cut off stale regimes
  - style/risk features plus dynamic allocation policies
"""
...
def select_with_lookback(train_df, val_df, index_df, configs, half_lives, policy_names, lookbacks):
    leaderboard = []
    best_key = None
    best = None
    for lookback in lookbacks:
        ...
        model, best_config, best_half_life, best_policy, metrics, inner_rows = select_model_and_policy(
            recent_train, val_df, index_df, configs, half_lives, policy_names
        )
...
def main() -> None:
    ...
    print(">> Building recent-style-dynamic feature panel")
