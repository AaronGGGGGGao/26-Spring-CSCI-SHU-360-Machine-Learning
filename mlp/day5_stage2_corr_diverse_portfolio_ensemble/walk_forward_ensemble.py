"""
Walk-forward robustness evaluation for the Stage 2 correlation-diversified portfolio ensemble.
"""
...
from mlp.day5_stage2_corr_diverse_portfolio_ensemble.ensemble_model import (  # noqa: E402
    FORWARD_HORIZON,
    TARGET_COLUMN,
    _branch_frames,
    _feature5d_frames,
...
def main() -> None:
    ...
    for spec in windows:
        ...
        ensemble_params, val_metrics, leaderboard = select_portfolio_ensemble(
            style_val_ports,
            feature_val_ports,
            frames["recent_val"],
            index_df,
        ...
        print(
            "   selected params: "
            f"style_weight={ensemble_params['style_recent_portfolio_weight']:.2f} / "
            f"corr_window={ensemble_params['corr_window']} / "
            f"corr_penalty={ensemble_params['corr_penalty']:.2f} / "
            f"target_names={ensemble_params['target_names']}"
        )
        print(
        ...
        results.append(
            {
                ...
                "selected_ensemble_params": ensemble_params,
                "style_recent": {
