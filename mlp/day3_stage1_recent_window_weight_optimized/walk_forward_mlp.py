"""
Walk-forward evaluation for the recent-window weight-optimized branch.
"""
...
def main() -> None:
    ...
    for spec in windows:
        ...
        test_metrics = evaluate_model_weight_optimized(
            model, test_df, index_df, top_k=best_top_k, weight_method=best_method
        )
    ...
    if args.json_out:
        out = {
            "dataset": "data",
            "model_family": "mlp_day3_stage1_recent_window_weight_optimized",
            "methodology": {
                "type": "walk_forward",
                "windows": args.windows,
                "val_days": args.val_days,
